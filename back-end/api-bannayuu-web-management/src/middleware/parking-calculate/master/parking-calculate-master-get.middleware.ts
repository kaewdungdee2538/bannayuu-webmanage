...
@Injectable()
export class ParkingCalculateMasterGetMiddleware implements NestMiddleware {
    constructor(
    ...
    async use(req: Request, res: Response, next: () => void) {
        ...
        if (messageCheckvalue) {
            console.log('Middleware check get parking calculate master value  : ' + messageCheckvalue)
            res.send({
                response: {
    ...
    async CheckValues(body: any) {
        ...
        else return await this.checkCPMInBase(body);
    }
