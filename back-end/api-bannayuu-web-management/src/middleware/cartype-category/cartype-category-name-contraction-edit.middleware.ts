...
@Injectable()
export class CartypeCategoryNameContractionEditMiddleware implements NestMiddleware {
    constructor(
    ...
    async CheckValues(body: any) {
        ...
        return await this.checkContractionCategoryDuplicate(body);
    }

    async checkContractionCategoryDuplicate(body) {
        ...
        and cartype_category_id != $3;`
        const query = {
            text: sql
            , values: [company_id, name_contraction,cartype_category_id]
        }
