...
@Injectable()
export class EstampHistoryMiddleware implements NestMiddleware {
    constructor(
    ...
    async use(req: Request, res: Response, next: () => void) {
        ...
        if (messageCheckvalue) {
            console.log('Middleware estamp history  : ' + messageCheckvalue)
            res.send({
                response: {
    ...
    async checkHomeAddressInBase(body: any) {
