...
@Injectable()
export class ParkingConfigSubCreateMiddleware implements NestMiddleware {
    constructor(
    ...
    async CheckValues(body: any) {
        ...
        return await this.checkIntervalBetweenInBaseIsDuplicate(body);
    }

    async checkIntervalBetweenInBaseIsDuplicate(body:any){
