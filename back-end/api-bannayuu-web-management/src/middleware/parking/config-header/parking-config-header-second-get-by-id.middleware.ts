...
@Injectable()
export class ParkingConfigHeaderSecondGetIdMiddleware implements NestMiddleware {
    constructor(
    ...
    async use(req: Request, res: Response, next: () => void) {
        ...
        if (messageCheckvalue) {
            console.log('Middleware parking config header second get id value  : ' + messageCheckvalue)
            res.send({
                response: {
