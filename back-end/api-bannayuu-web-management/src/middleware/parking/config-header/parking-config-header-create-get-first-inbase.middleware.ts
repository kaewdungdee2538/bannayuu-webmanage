...
@Injectable()
export class ParkingConfigHeaderCreateGetFirstIsInBaseMiddleware implements NestMiddleware {
    constructor(
    ...
    async CheckValues(body: any) {
        return await this.checkCPHFirstIsInBase(body);
    }

    async checkCPHFirstIsInBase(body: any) {
        ...
        if (res.error)
            ...
            return this.errMessageUrilTh.errCPHFirstNotInBase;
        else return null;
    }
