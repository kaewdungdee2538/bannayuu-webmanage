...
@Injectable()
export class ComplaintSearchMiddleware implements NestMiddleware {
    constructor(
    ...
    async CheckValues(body: any) {
        if (this.formatDataUtils.HaveSpecialHomeFormat(body.head_text))
            return this.errMessageUrilTh.errComplaintHeaderProhibitSpecial
