export class ErrMessageUtilsTH {
    ...
    errEmployeeIDProhibitSpecial = 'ไอดีพนักงานห้ามมีอักขระพิเศษ'
    errEmployeeNotInBase = 'ไม่พบพนักงานในระบบ'
    ...
    errPasswordOldNotFound = 'ไม่พบรหัสผ่านเก่า'
    errPasswordOldProhibitSpecial = 'รหัสผ่านเก่า ต้องเป็นอักษรภาษาอังกฤษ หรือตัวเลขเท่านั้น'
    errPasswordNewNotFound = 'ไม่พบรหัสผ่านใหม่'
    errPasswordNewProhibitSpecial = 'รหัสผ่าน ต้องเป็นอักษรภาษาอังกฤษ หรือตัวเลขเท่านั้น'
    errUsernameOrPasswordNotValid = 'Username หรือ Password ไม่ถูกต้อง'
