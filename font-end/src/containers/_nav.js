...
import { nav_home_head, nav_home_item, nav_license_item } from './nav/nav_home'
...
function GetNavBarItems(privilege_info) {
    ...
    if (privilege_info.payment.status && privilege_info.home.status) {
        _nav.push(nav_license_item)
    }
