...
const EstampHistoryGetAllController = (props)=>{
    ...
    return axios.post(`${ApiRoute.main_url}${ApiRoute.port}${ApiRoute.estamp.get_visitor_estamp_history_all_url}`
        , bodyParameters
        , config
    ).then((res) => { return res.data.response })
}

export default EstampHistoryGetAllController;