import './Complaint-reciept-main.css'
import {
    CButton,
    CCard,
    CCardBody,
...
import { ComplaintRecieptMainController } from './Complaint-reciept-main-controller'
...
const fields = ['ปิดคำร้อง', 'ที่อยู่', 'หัวข้อ', 'วันที่', 'สถานะ',]

function ComplaintRecieptMain() {
    ...
    function refeshFormFunc(reset) {
        if (!authStore.authorization) {
            ...
            ComplaintRecieptMainController({ authStore, searchObj })
                .then((res) => {
                    if (res.result) {
    ...
    if (showModal) {
        complatintModal = <ComplaintReceiptModal
                                            ...
                                            <td>
                                                <CButton
                                                    ...
                                                    <span
                                                        hci_id={item.hci_id}
                                                        hci_code={item.hci_code}
                                                        className="btn-icon">ปิดคำร้อง</span></CButton>
                                            </td>
                                        ), 'ที่อยู่': (item) => (
                                            <td>
                                                <span>
...
export default ComplaintRecieptMain;