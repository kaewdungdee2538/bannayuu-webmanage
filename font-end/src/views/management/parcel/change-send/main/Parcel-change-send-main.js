import './Parcel-change-send-main.css'
import {
    CButton,
    CCard,
    CCardBody,
...
import { ParcelChangeSendMainController } from './Parcel-change-send-main-controller'
...
function ParcelChangeSendMain() {
    ...
    function refeshFormFunc() {
        if (!authStore.authorization) {
            ...
            ParcelChangeSendMainController({ authStore, searchObj })
                .then((res) => {
                    if (res.result) {
    ...
    if (showEditModal) {
        parcelEditModal = <ParcelChangeSendModal
                        ...
                        <CCardBody>
                            ...
                            <CDataTable
                                ...
                                scopedSlots={{
                                    ...
                                    , 'วันที่ส่งพัสดุ': (item) => (
                                        <td>
                                            <span> {item.send_parcel_datetime}</span>
                                        </td>
                                    ), 'สถานะ': (item) => (
                                        <td>
...
export default ParcelChangeSendMain;