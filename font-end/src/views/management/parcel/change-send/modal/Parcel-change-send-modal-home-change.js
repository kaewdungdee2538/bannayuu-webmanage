...
import {changeHome} from './Parcel-change-send-modal-controller'
import InputEnable from '../../../component/input/InputEnable'
import store, { disAuthenticationLogin } from '../../../../../store'

function ParcelChangeSendModalHomeChange(props) {
    ...
    function onSelectHomeChangeClick(event) {
        ...
        swal({
            title: "Are you sure?",
            text: "ต้องการเปลี่ยนบ้านส่งพัสดุ หรือไม่",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
        ...
        changeHome({ authStore, selectedObj })
            .then(res => {
                if (res.error) {
                    ...
                    swal("Success", "เปลี่ยนบ้านส่งพัสดุเรียบร้อย", "success")
                        .then((value) => {
                            closeModal();
                        });
                }
...
export default ParcelChangeSendModalHomeChange;