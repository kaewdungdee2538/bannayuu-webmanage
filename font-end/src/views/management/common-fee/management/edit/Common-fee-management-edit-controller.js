...
export const CommonFeeManagementEditController = (props) => {
    ...
    return axios.post(`${ApiRoute.main_url}${ApiRoute.port}${ApiRoute.commonfee.edit_common_fee_url}`
        , bodyParameters
        , config
...
export const CommonFeeManagementGetById = (props) =>{
    ...
    return axios.post(`${ApiRoute.main_url}${ApiRoute.port}${ApiRoute.commonfee.get_common_fee_get_by_id_url}`
        , bodyParameters
        , config
    ).then((res) => { return res.data.response })
}
...
export const saveCancelCommonFee = (props) =>{
    ...
    return axios.post(`${ApiRoute.main_url}${ApiRoute.port}${ApiRoute.commonfee.cancel_common_fee_url}`
        , bodyParameters
        , config
    ).then((res) => { return res.data.response })
}
