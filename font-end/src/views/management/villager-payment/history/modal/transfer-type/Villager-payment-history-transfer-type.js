...
function VillagerPaymentHistoryTransferType(props) {
    const {
        villagerPaymentObj,
        imageBill,
        closeModal,
...
VillagerPaymentHistoryTransferType.propTypes = {
    villagerPaymentObj: PropTypes.any.isRequired,
    closeModal: PropTypes.func.isRequired,
}
export default VillagerPaymentHistoryTransferType;
