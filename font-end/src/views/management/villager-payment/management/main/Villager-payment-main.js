...
import VillagerPaymentEdit from '../edit/main/Villager-payment-edit'
const paymentEventText = {
    id: 0, value: 'เลือกการจ่ายเงิน'
}
function VillagerPaymentMain() {
    ...
    function refeshForm() {
        ...
        getVillagerPaymentNotApprove({ authStore, searchObj })
            .then((res) => {
                if (res.result) {
  ...
  //-----------------Set Show Modal
  let paymentShowModal = null;
  if (showModal) {
    paymentShowModal = <VillagerPaymentEdit
          showModal={showModal}
    ...
    return (
        <CCard>
            {loadingmodal}
            {paymentShowModal}
            <CCardHeader className="form-villager-payment-head">ตรวจสอบการชำระเงินของลูกบ้าน (โดยการโอนเงิน)</CCardHeader>
            <CCardBody>
                <CCol xs="12" lg="12">
                    <CCard>
                        <CCardHeader>
                            Villager payment Table
                    </CCardHeader>
                        <CCardBody>
                            <CRow>
                                            ...
                                            <td>
                                                <CButton
                                                    ...
                                                    <span
                                                        tpcfi_id={item.tpcfi_id}
                                                        tpcfi_code={item.tpcfi_code}
                                                        className="btn-icon">ตรวจสอบ</span></CButton>
                                            </td>
                                        )
                                    , 'สถานะ':
                                        (item) => (
...
export default VillagerPaymentMain;